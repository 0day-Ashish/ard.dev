  ...
  return (
    <main className="min-h-screen w-full bg-black text-white relative overflow-x-hidden cursor-none px-3 sm:px-0" style={{ cursor: 'none' }}>
      ...
      <section className="w-full h-screen flex flex-col items-center justify-center px-2 sm:px-4 py-10 relative mt-24">
        ...
        >
          <div
            className="space-y-2 leading-[0.9] flex flex-col items-center tracking-widest mt-[-7rem] md:mt-[-4rem] lg:mt-[2rem]"
          >
          ...
          <div className="text-xs md:text-xs text-white-300 max-w-sm absolute right-24 md:right-36 mt-32 md:mt-52" style={{marginRight: 0}}>
            ...
            {/* Arrow in circle for small screens only, below the last supporting text */}
          ...
          {/* Arrow in circle for large screens only, in original position */}
        ...
        <div className="absolute left-0 flex flex-col items-start" style={{ top: '11.5rem', left: '5rem' }}>
          {/* Responsive SCROLL text and icon */}
          <span
            className="mt-4 flex items-center text-white tracking-widest"
            style={{
              fontSize: '0.7rem',
              marginTop: '0.5rem',
              position: 'relative',
          ...
          >
            ...
            style={{
              fontSize: '0.6rem',
              top: '-6.2rem', // move even further up on mobile
              position: 'relative',
